...
function addIcons() {
    ...
    for (var i = e.getTotalLength(), n = 0; n < t.length; n++) {
        ...
        u.setAttributeNS(xlinkns, "xlink:href", "#icon-" + (n + 1)), u.setAttribute("width", iconWidth), u.setAttribute("height", iconHeight), u.setAttribute("x", l.x - u.getAttribute("width") / 2), u.setAttribute("y", l.y - u.getAttribute("height") / 2), u.setAttribute("transform", "rotate(" + (90 - 240 + 240 / 2) + " " + l.x + " " + l.y + ")"), r.appendChild(u);
